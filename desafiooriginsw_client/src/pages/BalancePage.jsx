...
function BalancePage() {
  ...
  const thClassName = 'className="px-6 mx-auto py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider';
  ...
  return (
    <div className='flex max-w-xl mx-auto'>
      <h1>Balance</h1>
      <table className="flex mx-auto table-auto min-w-full divide-y divide-gray-200">
        <thead className='flex bg-gray-50'>
          <tr className='flex justify-items-center'> 
